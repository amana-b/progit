...
#Region "定型準備"
    ...
    Public Shared Function ShowFrom(Value As String) As String
        Dim DialogForm As New dlgPrintLoc
    ...
    Private Sub Page_Initialize() Handles Me.PageInitialize
        ...
        ' ﾃｷｽﾄﾎﾞｯｸｽ
        Me.txt印刷場所CD.PropetyInitDialog(Windows.Forms.ImeMode.Disable, BaseContents.TextBox.TextStyle.None, NodeUI.Help.Type.None, "", "", tbl.印刷場所CDColumn.MaxLength, 0, 0)
...
#Region "ﾕｰｻﾞｲﾍﾞﾝﾄ"
    ...
    '''========================================================================================
    Private Sub txtKey_TextChanged(sender As Object, e As System.EventArgs) Handles txt印刷場所CD.TextChanged
        Me.GridBind()
    End Sub
#End Region
...
#Region "ｸﾞﾘｯﾄﾞ関連"
    ...
    Private Sub Grid_Initialize() Handles Me.GridInitialize
        ...
        '----------------------------------------------------------------------
        Dim tbl As New NodeDatabase.DataSetView.V0印刷場所DataTable
        Me.grdBase.DataKeyNames = tbl.印刷場所CDColumn.ColumnName
    End Sub
    ...
    Protected Sub Grid_Colums() Handles Me.GridColums
        ...
        '----------------------------------------------------------------------
        Dim tbl As New NodeDatabase.DataSetView.V0印刷場所DataTable
        Me.grdBase.Columns.Add(BaseUI.Common.GridView.NewColumn(tbl.印刷場所CDColumn))
        Me.grdBase.Columns.Add(BaseUI.Common.GridView.NewColumn(tbl.印刷場所名Column))
    End Sub
    ...
    Private Sub GridBind()
        ...
        '----------------------------------------------------------------------
        qry.Clear()
        qry.Add(New BaseDatabase.Condition(tbl.印刷場所CDColumn.ColumnName, Me.txt印刷場所CD.Text, BaseDatabase.Contents.Compare.LikeCenter, BaseDatabase.Contents.EmptyHandle.Skip))
