...
#Region "ﾌﾚｰﾑﾜｰｸ"
    Private Frame As NodeCore.Frame.Master.Personnel
#End Region
...
#Region "定型準備"
    ...
    Protected Overrides Sub ControlInit()
        ...
        ' ﾃｷｽﾄﾎﾞｯｸｽ
        Me.txt担当者CD.PropetyInitForm(BaseContents.Field.LockType.Key, False, Windows.Forms.ImeMode.Disable, BaseContents.TextBox.TextStyle.Code, NodeUI.Help.Type.M担当者, Me.txt担当者CD.Name, "")
        Me.txt担当者名.PropetyInitForm(BaseContents.Field.LockType.Key, False, Windows.Forms.ImeMode.On, BaseContents.TextBox.TextStyle.Code, NodeUI.Help.Type.None, "", "")
        Me.txtコーター金額.PropetyInitForm(BaseContents.Field.LockType.Data, False, Windows.Forms.ImeMode.Disable, BaseContents.TextBox.TextStyle.None, NodeUI.Help.Type.None, "", "")
        Me.txtコーター通数.PropetyInitForm(BaseContents.Field.LockType.Data, False, Windows.Forms.ImeMode.Disable, BaseContents.TextBox.TextStyle.None, NodeUI.Help.Type.None, "", "")
        Me.txt開始見積.PropetyInitForm(BaseContents.Field.LockType.Data, False, Windows.Forms.ImeMode.Disable, BaseContents.TextBox.TextStyle.None, NodeUI.Help.Type.None, "", "")
        ...
        ' ﾁｪｯｸﾎﾞｯｸｽ
        Me.chk売上日計表対象有無.PropetyInitForm(BaseContents.Field.LockType.None)
    ...
    Protected Overrides Sub FrameInit()
        ...
        ' ｺﾝｽﾄﾗｸﾀ
        '-------------------------------------
        Frame = New NodeCore.Frame.Master.Personnel(Me.Security, Me.Config)

        '-------------------------------------
        ' 紐付け
        '-------------------------------------
        Frame.Fields.Header.担当者CD.Control = Me.txt担当者CD
        Frame.Fields.Header.担当者名.Control = Me.txt担当者名
        Frame.Fields.Header.コーター通数.Control = Me.txtコーター通数
        Frame.Fields.Header.コーター金額.Control = Me.txtコーター金額
        Frame.Fields.Header.開始見積NO.Control = Me.txt開始見積
        Frame.Fields.Header.売上日計表対象有無.Control = Me.chk売上日計表対象有無
...
#Region "ﾕｰｻﾞｲﾍﾞﾝﾄ"
    ...
    '''========================================================================================
    Private Sub txt担当者CD_AfterUpdate(sender As Object, e As System.EventArgs) Handles txt担当者CD.AfterUpdate, txt担当者名.AfterUpdate, txt担当者CD.AfterUpdate
        '----------------------------------------------------------------------
        ' 該当ﾃﾞｰﾀ 読込
        '----------------------------------------------------------------------
        If Frame.Read() Then
