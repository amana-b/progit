...
Partial Class frmYamatoType
    ...
    Private Sub InitializeComponent()
        ...
        Me.grpヤマト区分名 = New BaseUI.Control.GroupBox()
        Me.txtヤマト区分名 = New BaseUI.Control.TextBox()
        ...
        Me.grpクロネコメール便バーコード情報 = New BaseUI.Control.GroupBox()
        ...
        Me.grp受注単価 = New BaseUI.Control.GroupBox()
        Me.Label11 = New BaseUI.Control.Label()
        Me.txt受注単価 = New BaseUI.Control.TextBox()
        Me.grp最大ケース数 = New BaseUI.Control.GroupBox()
        Me.Label13 = New BaseUI.Control.Label()
        Me.txt最大ケース数 = New BaseUI.Control.TextBox()
        Me.txt入数 = New BaseUI.Control.TextBox()
        Me.grp入数 = New BaseUI.Control.GroupBox()
        ...
        Me.grpヤマト区分名.SuspendLayout()
        Me.grp品名CD.SuspendLayout()
        Me.grp種別内訳区分.SuspendLayout()
        Me.grpクロネコメール便バーコード情報.SuspendLayout()
        Me.grp材料請求時単価.SuspendLayout()
        Me.grp受注単価.SuspendLayout()
        Me.grp最大ケース数.SuspendLayout()
        Me.grp入数.SuspendLayout()
        ...
        Me.grpヤマト区分.Location = New System.Drawing.Point(29, 107)
        Me.grpヤマト区分.Name = "grpヤマト区分"
        Me.grpヤマト区分.Size = New System.Drawing.Size(90, 61)
        ...
        Me.txtヤマト区分.ImeMode = System.Windows.Forms.ImeMode.NoControl
        Me.txtヤマト区分.IsError = False
        Me.txtヤマト区分.Location = New System.Drawing.Point(19, 25)
        Me.txtヤマト区分.Name = "txtヤマト区分"
        Me.txtヤマト区分.Required = False
        Me.txtヤマト区分.Size = New System.Drawing.Size(32, 23)
        ...
        'grpヤマト区分名
        '
        Me.grpヤマト区分名.Controls.Add(Me.txtヤマト区分名)
        Me.grpヤマト区分名.Font = New System.Drawing.Font("ＭＳ ゴシック", 12.0!)
        Me.grpヤマト区分名.Location = New System.Drawing.Point(161, 107)
        Me.grpヤマト区分名.Name = "grpヤマト区分名"
        Me.grpヤマト区分名.Size = New System.Drawing.Size(253, 61)
        Me.grpヤマト区分名.TabIndex = 2
        Me.grpヤマト区分名.TabStop = False
        Me.grpヤマト区分名.Text = "ﾃﾞｰﾀ区分名"
        '
        'txtヤマト区分名
        '
        Me.txtヤマト区分名.FieldLockType = BaseContents.Field.LockType.None
        Me.txtヤマト区分名.Font = New System.Drawing.Font("ＭＳ ゴシック", 12.0!)
        Me.txtヤマト区分名.HelpKeys = ""
        Me.txtヤマト区分名.HelpLink = ""
        Me.txtヤマト区分名.HelpType = NodeUI.Help.Type.None
        Me.txtヤマト区分名.ImeMode = System.Windows.Forms.ImeMode.Hiragana
        Me.txtヤマト区分名.IsError = False
        Me.txtヤマト区分名.Location = New System.Drawing.Point(19, 25)
        Me.txtヤマト区分名.Name = "txtヤマト区分名"
        Me.txtヤマト区分名.Required = False
        Me.txtヤマト区分名.Size = New System.Drawing.Size(205, 23)
        Me.txtヤマト区分名.TabIndex = 0
        Me.txtヤマト区分名.Text = "ああああああああああいい"
        Me.txtヤマト区分名.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'grp品名CD
        '
        ...
        Me.ddl種別内訳区分.FieldLockType = BaseContents.Field.LockType.None
        ...
        'grpクロネコメール便バーコード情報
        '
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.Label7)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.Label8)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.txtバーコード次回No3)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.Label9)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.txtバーコード次回No2)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.txtバーコード次回No1)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.Label4)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.Label5)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.txtバーコード終了No3)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.Label6)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.txtバーコード終了No2)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.txtバーコード終了No1)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.Label3)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.Label2)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.txtバーコード開始No3)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.Label1)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.txtバーコード開始No2)
        Me.grpクロネコメール便バーコード情報.Controls.Add(Me.txtバーコード開始No1)
        Me.grpクロネコメール便バーコード情報.Font = New System.Drawing.Font("ＭＳ ゴシック", 12.0!)
        Me.grpクロネコメール便バーコード情報.Location = New System.Drawing.Point(29, 539)
        Me.grpクロネコメール便バーコード情報.Name = "grpクロネコメール便バーコード情報"
        Me.grpクロネコメール便バーコード情報.Size = New System.Drawing.Size(720, 61)
        Me.grpクロネコメール便バーコード情報.TabIndex = 13
        Me.grpクロネコメール便バーコード情報.TabStop = False
        Me.grpクロネコメール便バーコード情報.Text = "クロネコメール便バーコード情報"
        '
        'Label7
        '
        ...
        'txtバーコード次回No3
        '
        Me.txtバーコード次回No3.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txtバーコード次回No3.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'Label9
        '
        ...
        'txtバーコード次回No2
        '
        Me.txtバーコード次回No2.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txtバーコード次回No2.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'txtバーコード次回No1
        '
        Me.txtバーコード次回No1.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txtバーコード次回No1.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'Label4
        '
        ...
        'txtバーコード終了No3
        '
        Me.txtバーコード終了No3.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txtバーコード終了No3.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'Label6
        '
        ...
        'txtバーコード終了No2
        '
        Me.txtバーコード終了No2.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txtバーコード終了No2.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'txtバーコード終了No1
        '
        Me.txtバーコード終了No1.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txtバーコード終了No1.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'Label3
        '
        ...
        'txtバーコード開始No3
        '
        Me.txtバーコード開始No3.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txtバーコード開始No3.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'Label1
        '
        ...
        'txtバーコード開始No2
        '
        Me.txtバーコード開始No2.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txtバーコード開始No2.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'txtバーコード開始No1
        '
        Me.txtバーコード開始No1.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txtバーコード開始No1.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'grp材料請求時単価
        '
        ...
        'txt材料請求時単価
        '
        Me.txt材料請求時単価.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txt材料請求時単価.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'grp受注単価
        '
        Me.grp受注単価.Controls.Add(Me.Label11)
        Me.grp受注単価.Controls.Add(Me.txt受注単価)
        Me.grp受注単価.Font = New System.Drawing.Font("ＭＳ ゴシック", 12.0!)
        Me.grp受注単価.Location = New System.Drawing.Point(381, 192)
        Me.grp受注単価.Name = "grp受注単価"
        Me.grp受注単価.Size = New System.Drawing.Size(134, 61)
        Me.grp受注単価.TabIndex = 7
        Me.grp受注単価.TabStop = False
        Me.grp受注単価.Text = "受注単価"
        '
        'Label11
        '
        ...
        'grp最大ケース数
        '
        Me.grp最大ケース数.Controls.Add(Me.Label13)
        Me.grp最大ケース数.Controls.Add(Me.txt最大ケース数)
        Me.grp最大ケース数.Font = New System.Drawing.Font("ＭＳ ゴシック", 12.0!)
        Me.grp最大ケース数.Location = New System.Drawing.Point(216, 192)
        Me.grp最大ケース数.Name = "grp最大ケース数"
        Me.grp最大ケース数.Size = New System.Drawing.Size(108, 61)
        Me.grp最大ケース数.TabIndex = 6
        Me.grp最大ケース数.TabStop = False
        Me.grp最大ケース数.Text = "最大ｹｰｽ数"
        '
        'Label13
        '
        ...
        'txt最大ケース数
        '
        Me.txt最大ケース数.FieldLockType = BaseContents.Field.LockType.None
        Me.txt最大ケース数.Font = New System.Drawing.Font("ＭＳ ゴシック", 12.0!)
        Me.txt最大ケース数.HelpKeys = ""
        Me.txt最大ケース数.HelpLink = ""
        Me.txt最大ケース数.HelpType = NodeUI.Help.Type.None
        Me.txt最大ケース数.ImeMode = System.Windows.Forms.ImeMode.NoControl
        Me.txt最大ケース数.IsError = False
        Me.txt最大ケース数.Location = New System.Drawing.Point(19, 25)
        Me.txt最大ケース数.Name = "txt最大ケース数"
        Me.txt最大ケース数.Required = False
        Me.txt最大ケース数.Size = New System.Drawing.Size(35, 23)
        Me.txt最大ケース数.TabIndex = 0
        Me.txt最大ケース数.Text = "123"
        Me.txt最大ケース数.TextAlign = System.Windows.Forms.HorizontalAlignment.Right
        Me.txt最大ケース数.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'txt入数
        '
        Me.txt入数.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txt入数.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'grp入数
        '
        Me.grp入数.Controls.Add(Me.Label12)
        Me.grp入数.Controls.Add(Me.txt入数)
        Me.grp入数.Font = New System.Drawing.Font("ＭＳ ゴシック", 12.0!)
        Me.grp入数.Location = New System.Drawing.Point(29, 192)
        Me.grp入数.Name = "grp入数"
        Me.grp入数.Size = New System.Drawing.Size(143, 61)
        Me.grp入数.TabIndex = 5
        Me.grp入数.TabStop = False
        Me.grp入数.Text = "入数"
        '
        'Label12
        '
        ...
        'grp光村印刷得意先CD
        '
        Me.grp光村印刷得意先CD.Controls.Add(Me.nam光村印刷得意先名)
        ...
        'nam光村印刷得意先名
        '
        Me.nam光村印刷得意先名.BackColor = System.Drawing.SystemColors.Control
        Me.nam光村印刷得意先名.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D
        Me.nam光村印刷得意先名.Font = New System.Drawing.Font("ＭＳ ゴシック", 12.0!)
        Me.nam光村印刷得意先名.Location = New System.Drawing.Point(79, 24)
        Me.nam光村印刷得意先名.Margin = New System.Windows.Forms.Padding(3)
        Me.nam光村印刷得意先名.Name = "nam光村印刷得意先名"
        Me.nam光村印刷得意先名.Padding = New System.Windows.Forms.Padding(0, 3, 0, 0)
        Me.nam光村印刷得意先名.Size = New System.Drawing.Size(264, 23)
        Me.nam光村印刷得意先名.TabIndex = 1
        Me.nam光村印刷得意先名.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'txt光村印刷得意先CD
        '
        Me.txt光村印刷得意先CD.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txt光村印刷得意先CD.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'grp光村印刷出荷先CD
        '
        Me.grp光村印刷出荷先CD.Controls.Add(Me.nam光村印刷出荷先名)
        ...
        'nam光村印刷出荷先名
        '
        Me.nam光村印刷出荷先名.BackColor = System.Drawing.SystemColors.Control
        Me.nam光村印刷出荷先名.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D
        Me.nam光村印刷出荷先名.Font = New System.Drawing.Font("ＭＳ ゴシック", 12.0!)
        Me.nam光村印刷出荷先名.Location = New System.Drawing.Point(51, 24)
        Me.nam光村印刷出荷先名.Margin = New System.Windows.Forms.Padding(3)
        Me.nam光村印刷出荷先名.Name = "nam光村印刷出荷先名"
        Me.nam光村印刷出荷先名.Padding = New System.Windows.Forms.Padding(0, 3, 0, 0)
        Me.nam光村印刷出荷先名.Size = New System.Drawing.Size(264, 23)
        Me.nam光村印刷出荷先名.TabIndex = 1
        Me.nam光村印刷出荷先名.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'txt光村印刷出荷先CD
        '
        Me.txt光村印刷出荷先CD.Enabled = False
        Me.txt光村印刷出荷先CD.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.txt光村印刷出荷先CD.TextStyle = BaseContents.TextBox.TextStyle.None
        '
        'grp材料請求時品名
        '
        ...
        'txt材料請求時品名
        '
        Me.txt材料請求時品名.FieldLockType = BaseContents.Field.LockType.None
        ...
        Me.Controls.Add(Me.grp受注単価)
        Me.Controls.Add(Me.grp最大ケース数)
        Me.Controls.Add(Me.grp入数)
        Me.Controls.Add(Me.grp材料請求時単価)
        Me.Controls.Add(Me.grpクロネコメール便バーコード情報)
        Me.Controls.Add(Me.grp種別内訳区分)
        Me.Controls.Add(Me.grp品名CD)
        Me.Controls.Add(Me.grpヤマト区分名)
        Me.Controls.Add(Me.grpヤマト区分)
        Me.Controls.Add(Me.grp処理区分)
        Me.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle
        Me.KeyPreview = True
        Me.Name = "frmYamatoType"
        Me.Text = ""
        Me.Controls.SetChildIndex(Me.grp処理区分, 0)
        Me.Controls.SetChildIndex(Me.grpヤマト区分, 0)
        Me.Controls.SetChildIndex(Me.grpヤマト区分名, 0)
        Me.Controls.SetChildIndex(Me.grp品名CD, 0)
        Me.Controls.SetChildIndex(Me.grp種別内訳区分, 0)
        Me.Controls.SetChildIndex(Me.grpクロネコメール便バーコード情報, 0)
        Me.Controls.SetChildIndex(Me.grp材料請求時単価, 0)
        Me.Controls.SetChildIndex(Me.grp入数, 0)
        Me.Controls.SetChildIndex(Me.grp最大ケース数, 0)
        Me.Controls.SetChildIndex(Me.grp受注単価, 0)
        ...
        Me.grpヤマト区分名.ResumeLayout(False)
        Me.grpヤマト区分名.PerformLayout()
        Me.grp品名CD.ResumeLayout(False)
        Me.grp品名CD.PerformLayout()
        Me.grp種別内訳区分.ResumeLayout(False)
        Me.grpクロネコメール便バーコード情報.ResumeLayout(False)
        Me.grpクロネコメール便バーコード情報.PerformLayout()
        Me.grp材料請求時単価.ResumeLayout(False)
        Me.grp材料請求時単価.PerformLayout()
        Me.grp受注単価.ResumeLayout(False)
        Me.grp受注単価.PerformLayout()
        Me.grp最大ケース数.ResumeLayout(False)
        Me.grp最大ケース数.PerformLayout()
        Me.grp入数.ResumeLayout(False)
        Me.grp入数.PerformLayout()
    ...
    Friend WithEvents grpヤマト区分名 As BaseUI.Control.GroupBox
    Friend WithEvents txtヤマト区分名 As BaseUI.Control.TextBox
    ...
    Friend WithEvents grpクロネコメール便バーコード情報 As BaseUI.Control.GroupBox
    ...
    Friend WithEvents grp受注単価 As BaseUI.Control.GroupBox
    Friend WithEvents txt受注単価 As BaseUI.Control.TextBox
    Friend WithEvents grp最大ケース数 As BaseUI.Control.GroupBox
    Friend WithEvents txt最大ケース数 As BaseUI.Control.TextBox
    ...
    Friend WithEvents grp入数 As BaseUI.Control.GroupBox
