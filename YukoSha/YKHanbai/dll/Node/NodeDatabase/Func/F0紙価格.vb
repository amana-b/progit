...
#Region "変数"
        Private datTable As New DataSetFunc.F0紙価格DataTable
#End Region
...
#Region "ﾌﾟﾛﾊﾟﾃｨ"
        Public Class Contents
            Public Shared ReadOnly Property 価格単価() As String
                Get
                    Return "価格単価"
                End Get
            End Property
...
#Region "ﾚｺｰﾄﾞの検索"
        ...
        Public Function SelectByCommon _
            ...
            Dim strSQL As String = Me.CommandCollection(0).CommandText

            Return BaseDatabase.Adapter.RecordSelect(Conditions, startRowIndex, maximumRows, sortExpression, Me.Connection, Me.CommandCollection(0), datTable, sortDefault, TopCount, , strSQL)
        End Function
#End Region
...
#Region "ﾚｺｰﾄﾞの件数"
        ...
        Public Function CountByCommon _
            ...
            Return BaseDatabase.Adapter.RecordCount(Conditions, startRowIndex, maximumRows, sortExpression, Me.Connection, Me.CommandCollection(0), datTable, strSQL)
        End Function
#End Region
    End Class
End Namespace
