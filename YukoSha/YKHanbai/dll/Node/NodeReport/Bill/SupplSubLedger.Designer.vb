...
Partial Public Class SupplSubLedger
    ...
    Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(SupplSubLedger))
        ...
        Me.lbl補助CD = New DataDynamics.ActiveReports.Label()
        Me.txt補助CD = New DataDynamics.ActiveReports.TextBox()
        Me.txt補助名 = New DataDynamics.ActiveReports.TextBox()
        ...
        CType(Me.lbl補助CD, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.txt補助CD, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.txt補助名, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.txt借方金額.Height = 0.3543307!
        Me.txt借方金額.Left = 2.952756!
        Me.txt借方金額.Name = "txt借方金額"
        Me.txt借方金額.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: right; vertical-align: middle; d" & _
    "do-char-set: 1"
    ...
    "-char-set: 1"
        ...
        Me.txt差引残高.Height = 0.3543307!
        Me.txt差引残高.Left = 5.708662!
        Me.txt差引残高.Name = "txt差引残高"
        Me.txt差引残高.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: right; vertical-align: middle; d" & _
    "do-char-set: 1"
        ...
        Me.txt貸方残高.Height = 0.3543307!
        Me.txt貸方残高.Left = 4.291339!
        Me.txt貸方残高.Name = "txt貸方残高"
        Me.txt貸方残高.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: right; vertical-align: middle; d" & _
    "do-char-set: 1"
    ...
    "ddo-char-set: 1"
        ...
        'grpHdr
        '
        Me.grpHdr.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txt入金明細表, Me.lbl伝票No, Me.lbl貸方残高, Me.lbl年月日, Me.lbl相手科目名, Me.lbl借方金額, Me.Label2, Me.txt科目名, Me.txt科目CD, Me.Label3, Me.lbl摘要, Me.lbl事業年度, Me.txt事業年度, Me.lbl計算期間, Me.txt計算期間, Me.txtNow, Me.txt頁, Me.lbl補助CD, Me.txt補助CD, Me.txt補助名})
        ...
        Me.txt入金明細表.CharacterSpacing = 25.0!
    ...
    "rtical-align: bottom; ddo-char-set: 1"
        ...
        Me.lbl伝票No.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        ...
        Me.lbl貸方残高.Left = 4.291338!
        Me.lbl貸方残高.Name = "lbl貸方残高"
        Me.lbl貸方残高.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        ...
        Me.lbl年月日.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.lbl年月日.Text = "年月日"
        ...
        Me.lbl相手科目名.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        ...
        Me.lbl借方金額.Left = 2.952755!
        Me.lbl借方金額.Name = "lbl借方金額"
        Me.lbl借方金額.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        ...
        Me.Label2.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.Label2.Text = "科目コード"
        Me.Label2.Top = 0.184252!
        Me.Label2.Width = 0.9055118!
        '
        'txt科目名
        '
        Me.txt科目名.Height = 0.1968504!
        Me.txt科目名.Left = 1.338583!
        Me.txt科目名.Name = "txt科目名"
        Me.txt科目名.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-align: bottom; " & _
    "ddo-char-set: 1"
        Me.txt科目名.Text = "あああああ"
        Me.txt科目名.Top = 0.184252!
        Me.txt科目名.Width = 0.9448819!
        '
        'txt科目CD
        '
        Me.txt科目CD.Height = 0.1968504!
        Me.txt科目CD.Left = 0.9055118!
        Me.txt科目CD.Name = "txt科目CD"
        Me.txt科目CD.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-align: bottom; " & _
    "ddo-char-set: 1"
        Me.txt科目CD.Text = "123"
        Me.txt科目CD.Top = 0.184252!
        Me.txt科目CD.Width = 0.4330709!
        '
        'Label3
        '
    ...
    "lign: middle; ddo-char-set: 1"
        ...
        Me.lbl摘要.Name = "lbl摘要"
        Me.lbl摘要.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.lbl摘要.Text = "摘要"
    ...
    "o-char-set: 1"
        Me.txt月累計借方金額.Text = "999,999,999"
    ...
    "o-char-set: 1"
        Me.txt月累計差引残高.Text = "999,999,999"
    ...
    "do-char-set: 1"
        ...
        Me.txt前日繰越借方金額.Left = 2.952755!
        Me.txt前日繰越借方金額.Name = "txt前日繰越借方金額"
        Me.txt前日繰越借方金額.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: right; vertical-align: middle; d" & _
    "do-char-set: 1"
        ...
        Me.txt前日繰越貸方残高.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: right; vertical-align: middle; d" & _
    "do-char-set: 1"
        ...
        Me.txt前日繰越差引残高.Left = 5.708662!
        Me.txt前日繰越差引残高.Name = "txt前日繰越差引残高"
        Me.txt前日繰越差引残高.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: right; vertical-align: middle; d" & _
    "do-char-set: 1"
    ...
    "lign: middle; ddo-char-set: 1"
        ...
        Me.txtNow.Left = 7.851182!
        Me.txtNow.Name = "txtNow"
        Me.txtNow.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; text-justify: auto; vert" & _
    "ical-align: top; ddo-char-set: 1"
        ...
        Me.txt頁.Left = 10.12377!
        Me.txt頁.Name = "txt頁"
        Me.txt頁.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; text-justify: auto; vert" & _
    "ical-align: top; ddo-char-set: 1"
        Me.txt頁.Text = "頁"
        Me.txt頁.Top = 0.0!
        ...
        'lbl補助CD
        '
        Me.lbl補助CD.Height = 0.1968504!
        Me.lbl補助CD.HyperLink = Nothing
        Me.lbl補助CD.Left = 0.0!
        Me.lbl補助CD.Name = "lbl補助CD"
        Me.lbl補助CD.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.lbl補助CD.Text = "補助コード"
        Me.lbl補助CD.Top = 0.4503937!
        Me.lbl補助CD.Width = 0.9055118!
        '
        'txt補助CD
        '
        Me.txt補助CD.Height = 0.1968504!
        Me.txt補助CD.Left = 0.9055118!
        Me.txt補助CD.Name = "txt補助CD"
        Me.txt補助CD.Style = "font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-align: bottom; " & _
    "ddo-char-set: 1"
        Me.txt補助CD.Text = "123"
        Me.txt補助CD.Top = 0.4503937!
        Me.txt補助CD.Width = 0.4330708!
        '
        'txt補助名
        '
        Me.txt補助名.Height = 0.1968504!
        Me.txt補助名.Left = 1.338583!
        Me.txt補助名.Name = "txt補助名"
        Me.txt補助名.Style = "font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-align: bottom; " & _
    "ddo-char-set: 1"
        Me.txt補助名.Text = "あああああ"
        Me.txt補助名.Top = 0.4503937!
        Me.txt補助名.Width = 0.9448819!
        '
        'SupplSubLedger
        '
        ...
        CType(Me.lbl補助CD, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txt補助CD, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txt補助名, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Private WithEvents lbl補助CD As DataDynamics.ActiveReports.Label
    Private WithEvents txt補助CD As DataDynamics.ActiveReports.TextBox
    Private WithEvents txt補助名 As DataDynamics.ActiveReports.TextBox
End Class
