...
Partial Public Class DepositBill
    ...
    Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(DepositBill))
        Me.Detail = New DataDynamics.ActiveReports.Detail()
        Me.txt入金日 = New DataDynamics.ActiveReports.TextBox()
        ...
        Me.txt借方科目名 = New DataDynamics.ActiveReports.TextBox()
        Me.txt入金No = New DataDynamics.ActiveReports.TextBox()
        Me.txt入金区分名 = New DataDynamics.ActiveReports.TextBox()
        ...
        Me.txt総合計入金区分名 = New DataDynamics.ActiveReports.TextBox()
        ...
        Me.lbl入金日 = New DataDynamics.ActiveReports.Label()
        ...
        Me.lbl借方科目名 = New DataDynamics.ActiveReports.Label()
        Me.lbl入金No = New DataDynamics.ActiveReports.Label()
        Me.txt入金区分 = New DataDynamics.ActiveReports.Label()
        ...
        Me.txt入金日計入金区分名 = New DataDynamics.ActiveReports.TextBox()
        Me.TextBox16 = New DataDynamics.ActiveReports.TextBox()
        Me.Label1 = New DataDynamics.ActiveReports.Label()
        Me.TextBox13 = New DataDynamics.ActiveReports.TextBox()
        Me.TextBox21 = New DataDynamics.ActiveReports.TextBox()
        Me.TextBox5 = New DataDynamics.ActiveReports.TextBox()
        CType(Me.txt入金日, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.txt借方科目名, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.txt入金No, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.txt入金区分名, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.txt総合計入金区分名, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.lbl入金日, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.lbl借方科目名, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.lbl入金No, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.txt入金区分, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.txt入金日計入金区分名, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.Detail.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txt入金日, Me.txt摘要, Me.txt得意先名, Me.txt科目CD, Me.txt得意先CD, Me.txt入金額, Me.txt借方科目名, Me.txt入金No, Me.txt入金区分名})
        ...
        'txt入金日
        '
        Me.txt入金日.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金日.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金日.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金日.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金日.Height = 0.2755905!
        Me.txt入金日.Left = 0.0!
        Me.txt入金日.Name = "txt入金日"
        Me.txt入金日.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-align: middle; " & _
    "ddo-char-set: 1"
        Me.txt入金日.Text = "YY/MM/DD"
        Me.txt入金日.Top = 0.0!
        Me.txt入金日.Width = 0.6692914!
        '
        'txt摘要
        '
        ...
        Me.txt摘要.Name = "txt摘要"
        Me.txt摘要.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-align: middle; " & _
    "ddo-char-set: 1"
        ...
        Me.txt得意先名.Left = 1.751969!
        Me.txt得意先名.Name = "txt得意先名"
        Me.txt得意先名.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: left; vertical-align: middle; dd" & _
    "o-char-set: 1"
        Me.txt得意先名.Text = "あああああいいい"
        Me.txt得意先名.Top = 0.0000001788139!
        Me.txt得意先名.Width = 2.401575!
        '
        'txt科目CD
        '
    ...
    "ddo-char-set: 1"
        ...
        Me.txt入金額.Height = 0.2755905!
        Me.txt入金額.Left = 5.098425!
        Me.txt入金額.Name = "txt入金額"
        Me.txt入金額.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: right; vertical-align: middle; d" & _
    "do-char-set: 1"
        Me.txt入金額.Text = "999,999"
        Me.txt入金額.Top = 0.00000005960464!
        Me.txt入金額.Width = 1.220472!
        '
        'txt借方科目名
        '
        Me.txt借方科目名.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt借方科目名.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt借方科目名.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt借方科目名.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt借方科目名.Height = 0.2755905!
        Me.txt借方科目名.Left = 6.791339!
        Me.txt借方科目名.Name = "txt借方科目名"
        Me.txt借方科目名.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-align: middle; " & _
    "ddo-char-set: 1"
        Me.txt借方科目名.Text = "あああああ"
        Me.txt借方科目名.Top = 0.0000002384186!
        Me.txt借方科目名.Width = 0.8858268!
        '
        'txt入金No
        '
        Me.txt入金No.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金No.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金No.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金No.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金No.Height = 0.2755905!
        Me.txt入金No.Left = 0.6692914!
        Me.txt入金No.Name = "txt入金No"
        Me.txt入金No.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-align: middle; " & _
    "ddo-char-set: 1"
        Me.txt入金No.Text = "1234567"
        Me.txt入金No.Top = 0.0000002384186!
        Me.txt入金No.Width = 0.5708662!
        '
        'txt入金区分名
        '
        Me.txt入金区分名.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金区分名.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金区分名.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金区分名.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金区分名.Height = 0.2755905!
        Me.txt入金区分名.Left = 4.153543!
        Me.txt入金区分名.Name = "txt入金区分名"
        Me.txt入金区分名.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-align: middle; " & _
    "ddo-char-set: 1"
        Me.txt入金区分名.Text = "ああああ"
        Me.txt入金区分名.Top = 0.0000004470348!
        Me.txt入金区分名.Width = 0.9448819!
        '
        'PageHeader
        '
    ...
    "ddo-char-set: 1"
        ...
        'grpFtr総合計
        '
        Me.grpFtr総合計.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.TextBox8, Me.TextBox4, Me.TextBox2, Me.txt総合計, Me.txt総合計入金区分名, Me.txt仕上日計件数, Me.Label3, Me.TextBox6, Me.TextBox10, Me.TextBox9})
    ...
    "ddo-char-set: 1"
        ...
        Me.txt総合計.Left = 5.098425!
        Me.txt総合計.Name = "txt総合計"
        Me.txt総合計.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: right; vertical-align: middle; d" & _
    "do-char-set: 1"
        ...
        Me.txt総合計.Width = 1.220472!
        '
        'txt総合計入金区分名
        '
        Me.txt総合計入金区分名.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt総合計入金区分名.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt総合計入金区分名.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt総合計入金区分名.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt総合計入金区分名.Height = 0.2755906!
        Me.txt総合計入金区分名.Left = 4.153543!
        Me.txt総合計入金区分名.Name = "txt総合計入金区分名"
        Me.txt総合計入金区分名.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-align: middle; " & _
    "ddo-char-set: 1"
        Me.txt総合計入金区分名.Text = "ああああ"
        Me.txt総合計入金区分名.Top = 0.0000004470349!
        Me.txt総合計入金区分名.Width = 0.944882!
        '
        'txt仕上日計件数
        '
    ...
    "o-char-set: 1"
        ...
        'grpHdr
        '
        Me.grpHdr.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txtHdr仕入日, Me.txt入金明細表, Me.lbl入金日, Me.lbl摘要, Me.lbl得意先名, Me.lbl入金額, Me.lbl得意先CD, Me.lbl科目CD, Me.lblHdr入金日, Me.lbl借方科目名, Me.lbl入金No, Me.txt入金区分})
    ...
    "ddo-char-set: 1"
        Me.txt入金明細表.Text = "入 金 明 細 表"
        Me.txt入金明細表.Top = 0.08110237!
        Me.txt入金明細表.Width = 2.681497!
        '
        'lbl入金日
        '
        Me.lbl入金日.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl入金日.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl入金日.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl入金日.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl入金日.Height = 0.3346457!
        Me.lbl入金日.HyperLink = Nothing
        Me.lbl入金日.Left = 0.0!
        Me.lbl入金日.Name = "lbl入金日"
        Me.lbl入金日.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.lbl入金日.Text = "入金日"
        Me.lbl入金日.Top = 0.4141732!
        Me.lbl入金日.Width = 0.6692914!
        '
        'lbl摘要
        '
    ...
    "lign: middle; ddo-char-set: 1"
        ...
        Me.lbl入金額.Height = 0.3346457!
        Me.lbl入金額.HyperLink = Nothing
        Me.lbl入金額.Left = 5.098425!
        Me.lbl入金額.Name = "lbl入金額"
        Me.lbl入金額.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.lbl入金額.Text = "入金額"
        Me.lbl入金額.Top = 0.4141732!
        Me.lbl入金額.Width = 1.220472!
        '
        'lbl得意先CD
        '
    ...
    "lign: middle; ddo-char-set: 1"
        ...
        Me.lblHdr入金日.Left = 0.0!
        Me.lblHdr入金日.Name = "lblHdr入金日"
        Me.lblHdr入金日.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.lblHdr入金日.Text = "入金日"
        Me.lblHdr入金日.Top = 0.0!
        Me.lblHdr入金日.Width = 0.7874014!
        '
        'lbl借方科目名
        '
        Me.lbl借方科目名.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl借方科目名.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl借方科目名.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl借方科目名.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl借方科目名.Height = 0.3346457!
        Me.lbl借方科目名.HyperLink = Nothing
        Me.lbl借方科目名.Left = 6.791339!
        Me.lbl借方科目名.Name = "lbl借方科目名"
        Me.lbl借方科目名.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.lbl借方科目名.Text = "借方科目名"
        Me.lbl借方科目名.Top = 0.4141732!
        Me.lbl借方科目名.Width = 0.8858268!
        '
        'lbl入金No
        '
        Me.lbl入金No.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl入金No.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl入金No.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl入金No.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl入金No.Height = 0.3346457!
        Me.lbl入金No.HyperLink = Nothing
        Me.lbl入金No.Left = 0.6692914!
        Me.lbl入金No.Name = "lbl入金No"
        Me.lbl入金No.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.lbl入金No.Text = "入金No"
        Me.lbl入金No.Top = 0.4141732!
        Me.lbl入金No.Width = 0.5708662!
        '
        'txt入金区分
        '
        Me.txt入金区分.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金区分.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金区分.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金区分.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金区分.Height = 0.3346457!
        Me.txt入金区分.HyperLink = Nothing
        Me.txt入金区分.Left = 4.153543!
        Me.txt入金区分.Name = "txt入金区分"
        Me.txt入金区分.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.txt入金区分.Text = "入金区分"
        Me.txt入金区分.Top = 0.4141732!
        Me.txt入金区分.Width = 0.9448819!
        '
        'grpFtr計
        '
    ...
    "o-char-set: 1"
        ...
        'grpFtr入金日計
        '
        Me.grpFtr入金日計.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.TextBox18, Me.txt出荷先名, Me.TextBox12, Me.txt入金日計, Me.txt入金日計入金区分名, Me.TextBox16, Me.Label1, Me.TextBox13, Me.TextBox21, Me.TextBox5})
    ...
    "do-char-set: 1"
        ...
        'txt入金日計入金区分名
        '
        Me.txt入金日計入金区分名.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金日計入金区分名.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金日計入金区分名.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金日計入金区分名.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt入金日計入金区分名.Height = 0.2755906!
        Me.txt入金日計入金区分名.Left = 4.153543!
        Me.txt入金日計入金区分名.Name = "txt入金日計入金区分名"
        Me.txt入金日計入金区分名.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: center; vertical-align: middle; " & _
    "ddo-char-set: 1"
        Me.txt入金日計入金区分名.Text = "ああああ"
        Me.txt入金日計入金区分名.Top = 0.0000004470349!
        Me.txt入金日計入金区分名.Width = 0.944882!
        '
        'TextBox16
        '
    ...
    "o-char-set: 1"
        ...
        CType(Me.txt入金日, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.txt借方科目名, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txt入金No, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txt入金区分名, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.txt総合計入金区分名, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.lbl入金日, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.lbl借方科目名, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.lbl入金No, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txt入金区分, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.txt入金日計入金区分名, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Private WithEvents txt入金日 As DataDynamics.ActiveReports.TextBox
    ...
    Private WithEvents txt借方科目名 As DataDynamics.ActiveReports.TextBox
    Private WithEvents txt入金No As DataDynamics.ActiveReports.TextBox
    Private WithEvents txt入金区分名 As DataDynamics.ActiveReports.TextBox
    ...
    Private WithEvents lbl入金日 As DataDynamics.ActiveReports.Label
    ...
    Private WithEvents lbl借方科目名 As DataDynamics.ActiveReports.Label
    Private WithEvents lbl入金No As DataDynamics.ActiveReports.Label
    Private WithEvents txt入金区分 As DataDynamics.ActiveReports.Label
    ...
    Private WithEvents txt入金日計入金区分名 As DataDynamics.ActiveReports.TextBox
    ...
    Private WithEvents txt総合計入金区分名 As DataDynamics.ActiveReports.TextBox
