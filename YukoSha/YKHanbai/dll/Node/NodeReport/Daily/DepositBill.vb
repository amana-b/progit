...
Public Class DepositBill
    ...
    '''========================================================================================
    Private Sub DepositBill_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
    ...
    Private Sub GroupFooter2_Format(sender As System.Object, e As System.EventArgs) Handles grpFtr総合計.Format

    End Sub

    Private Sub GroupFooter1_Format(sender As System.Object, e As System.EventArgs) Handles grpFtr入金日計.Format
