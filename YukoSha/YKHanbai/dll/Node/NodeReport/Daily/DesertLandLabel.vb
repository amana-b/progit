...
Public Class DesertLandLabel
    ...
    '''========================================================================================
    Private Sub DesertLandLabel_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        ' ｸﾞﾙｰﾌﾟ ﾌｯﾀ
        '------------------------------------------------------------------------------------------
        Me.grpFtr金額計.NewPage = NewPage.After
    ...
    Private Sub grpFtr得意先CD_Format(sender As System.Object, e As System.EventArgs) Handles grpFtr金額計.Format
    ...
    Private Sub GroupFooter2_Format(sender As System.Object, e As System.EventArgs) Handles grpFtr枚数計.Format

    End Sub

    Private Sub GroupFooter1_Format(sender As System.Object, e As System.EventArgs) Handles grpFtr巻数計.Format
