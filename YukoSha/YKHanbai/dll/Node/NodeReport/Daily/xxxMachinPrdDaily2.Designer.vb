...
Partial Public Class xxxMachinPrdDaily2
    ...
    Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(xxxMachinPrdDaily2))
    ...
    "ddo-char-set: 1"
        ...
        'grpHdr
        '
        Me.grpHdr.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txtHdr仕入日, Me.txt仕入日計累計表, Me.lbl仕入日, Me.lbl運賃, Me.lbl版刃型版下代, Me.lbl原紙代, Me.ｌｂｌ商品名, Me.lblHdr仕入日, Me.lbl印刷工賃, Me.lbl折代})
