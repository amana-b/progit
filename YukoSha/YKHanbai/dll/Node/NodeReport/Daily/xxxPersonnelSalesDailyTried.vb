...
Public Class xxxPersonnelSalesDailyTried
    ...
    '''========================================================================================
    Private Sub xxxPersonnelSalesDailyTried_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
    ...
    Private Sub GroupFooter2_Format(sender As System.Object, e As System.EventArgs) Handles grpFtr.Format
