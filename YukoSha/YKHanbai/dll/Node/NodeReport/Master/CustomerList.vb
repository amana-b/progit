...
Public Class CustomerList
    ...
    '''========================================================================================
    Private Sub CustomerList_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        Me.txt自社担当者名.DataField = tbl.自社担当者名Column.ColumnName
        ...
        ' ｻﾌﾞﾚﾎﾟｰﾄ
        '------------------------------------------------------------------------------------------
        Me.SubReport.Report = New NodeReport.CustomerListSub
        Me.SubReport.ReportName = "CustomerListSub"
