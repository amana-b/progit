...
Partial Public Class SupplierListSub
    ...
    Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(SupplierListSub))
    ...
    "do-char-set: 1"
        ...
        'grpHdr仕入先CD
        '
        Me.grpHdr仕入先CD.DataField = "得意先CD"
        Me.grpHdr仕入先CD.Height = 0.0!
        Me.grpHdr仕入先CD.Name = "grpHdr仕入先CD"
        '
        'grpFtr仕入先CD
        '
        Me.grpFtr仕入先CD.Height = 0.0!
