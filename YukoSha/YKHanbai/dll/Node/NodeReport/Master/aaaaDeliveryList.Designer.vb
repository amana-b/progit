...
Partial Public Class aaaaDeliveryList
    ...
    Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(aaaaDeliveryList))
        ...
        Me.txtdtl出荷先CD.DataField = "出荷先CD"
    ...
    "ddo-char-set: 1"
        ...
        'grpHdr得意先CD
        '
        Me.grpHdr得意先CD.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.lblSlipDate, Me.lbl出荷先CD, Me.txt得意先名, Me.txt得意先CD, Me.lbl得意先, Me.lbl出荷先名, Me.lbl郵便番号, Me.lbl住所, Me.lblTEL})
    ...
    "n: center; vertical-align: middle; ddo-char-set: 1"
        Me.lblSlipDate.Text = "出 荷 先 リ ス ト"
        Me.lblSlipDate.Top = 0.0!
        Me.lblSlipDate.Width = 3.0!
        '
        'lbl出荷先CD
        '
