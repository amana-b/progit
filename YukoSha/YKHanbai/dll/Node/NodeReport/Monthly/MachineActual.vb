...
Public Class MachineActual
    ...
    '''========================================================================================
    Private Sub MachineActual_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        ' ｸﾞﾙｰﾌﾟ ﾌｯﾀ
        '------------------------------------------------------------------------------------------
        Me.grpFtr合計.NewPage = NewPage.After
    ...
    Private Sub grpFtr得意先CD_Format(sender As System.Object, e As System.EventArgs) Handles grpFtr合計.Format
    ...
    Private Sub GroupFooter1_Format_1(sender As System.Object, e As System.EventArgs) Handles grpFtr小計.Format
