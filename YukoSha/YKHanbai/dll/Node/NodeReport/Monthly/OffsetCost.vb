...
Public Class OffsetCost
    ...
    '''========================================================================================
    Private Sub OffsetCost_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        ' ｸﾞﾙｰﾌﾟ ﾌｯﾀ
        '------------------------------------------------------------------------------------------
        Me.grpFtr計.NewPage = NewPage.After
    ...
    Private Sub grpFtr得意先CD_Format(sender As System.Object, e As System.EventArgs) Handles grpFtr計.Format
    ...
    Private Sub grpHdr得意先CD_Format(sender As System.Object, e As System.EventArgs) Handles grpHdr.Format

    End Sub

    Private Sub GroupHeader1_Format(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub GroupFooter2_Format(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub GroupFooter1_Format(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub GroupFooter1_Format_1(sender As System.Object, e As System.EventArgs) Handles GroupFooter1.Format

    End Sub

    Private Sub GroupFooter2_Format_1(sender As System.Object, e As System.EventArgs) Handles GroupFooter2.Format
