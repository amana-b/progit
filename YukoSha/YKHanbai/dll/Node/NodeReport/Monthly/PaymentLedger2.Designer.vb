...
Partial Public Class PaymentLedger2
    ...
    Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PaymentLedger2))
    ...
    "do-char-set: 1"
        Me.txt納入場所.Text = "ああああ"
        Me.txt納入場所.Top = 0.2165357!
        Me.txt納入場所.Width = 0.6299213!
        '
        'TextBox1
        '
    ...
    "do-char-set: 1"
        ...
        Me.txt作業No.Left = 5.492126!
        Me.txt作業No.Name = "txt作業No"
        Me.txt作業No.Style = "font-family: ＭＳ 明朝; font-size: 9.5pt; text-align: left; vertical-align: bottom; d" & _
    "do-char-set: 1"
    ...
    "ddo-char-set: 1"
        ...
        'grpHdr
        '
        Me.grpHdr.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txtHdr対象年月, Me.txt得意先元帳, Me.lbl伝票区分, Me.lbl当月残高, Me.lbl伝票No, Me.lbl商品名摘要, Me.lbl対象年月, Me.lbl単価, Me.lblHdr対象年月, Me.lbl出金額, Me.lbl数量, Me.lbl仕入金額, Me.lbl納入場所, Me.lbl仕入先, Me.txt仕入先CD, Me.txt仕入先名, Me.lbl作業No})
    ...
    "rtical-align: bottom; ddo-char-set: 1"
        Me.txt得意先元帳.Text = "仕入先　元帳"
        Me.txt得意先元帳.Top = 0.0!
        Me.txt得意先元帳.Width = 2.72559!
        '
        'lbl伝票区分
        '
    ...
    "ign: middle; ddo-char-set: 1"
        ...
        'grpFtr計
        '
        Me.grpFtr計.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txt当月残高合計, Me.txt出金合計金額, Me.TextBox4, Me.TextBox2, Me.txt仕入金額合計, Me.TextBox17, Me.TextBox19, Me.TextBox3, Me.TextBox, Me.TextBox8, Me.Label1, Me.TextBox15})
    ...
    "right; vertical-align: bottom; ddo-char-set: 1"
        ...
        Me.TextBox15.Left = 5.492126!
        Me.TextBox15.Name = "TextBox15"
        Me.TextBox15.Style = "font-family: ＭＳ 明朝; font-size: 9.5pt; text-align: left; vertical-align: bottom; d" & _
    "do-char-set: 1"
        Me.TextBox15.Text = Nothing
        Me.TextBox15.Top = 0.0!
        Me.TextBox15.Width = 0.472441!
        '
        'PaymentLedger2
        '
