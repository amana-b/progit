...
Partial Public Class PaymentLedgerNo1
    ...
    Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PaymentLedgerNo1))
    ...
    "ddo-char-set: 1"
        ...
        'grpHdr
        '
        Me.grpHdr.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txtHdr対象年月, Me.txt得意先元帳, Me.lbl伝票区分, Me.lbl当月残高, Me.lbl自社伝票No, Me.lbl商品名, Me.lbl対象年月, Me.lbl単価, Me.lblHdr対象年月, Me.lbl出金額, Me.lbl数量, Me.lbl仕入金額, Me.lbl相手伝票No, Me.lbl仕入先, Me.txt仕入先CD, Me.txt仕入先名})
