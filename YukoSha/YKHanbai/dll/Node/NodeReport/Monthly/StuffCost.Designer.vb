...
Partial Public Class StuffCost
    ...
    Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(StuffCost))
        ...
        Me.lbl担当者CD = New DataDynamics.ActiveReports.Label()
        ...
        CType(Me.lbl担当者CD, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.Detail.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txt仕入, Me.txt粗利, Me.txt通数, Me.txt担当者CD, Me.txt担当者名, Me.txt諸経費, Me.txt売上, Me.txt固定経費, Me.txt利益, Me.txt通数m, Me.txt利益率})
    ...
    "o-char-set: 1"
        ...
        Me.txt担当者CD.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt担当者CD.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt担当者CD.Height = 0.2755905!
        Me.txt担当者CD.Left = 0.0!
        Me.txt担当者CD.Name = "txt担当者CD"
        Me.txt担当者CD.Style = "font-family: ＭＳ 明朝; font-size: 9.5pt; text-align: center; vertical-align: bottom;" & _
    " ddo-char-set: 1"
        Me.txt担当者CD.Text = "123456"
        Me.txt担当者CD.Top = 0.00000005960464!
        Me.txt担当者CD.Width = 0.6299213!
        '
        'txt担当者名
        '
        Me.txt担当者名.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt担当者名.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        ...
        Me.txt担当者名.Left = 0.6299213!
        Me.txt担当者名.Name = "txt担当者名"
        Me.txt担当者名.Style = "font-family: ＭＳ 明朝; font-size: 9.5pt; text-align: justify; vertical-align: bottom" & _
    "; ddo-char-set: 1"
        Me.txt担当者名.Text = "あああああいいい"
        Me.txt担当者名.Top = 0.0000001192093!
        Me.txt担当者名.Width = 2.145669!
        '
        'txt諸経費
        '
    ...
    "ddo-char-set: 1"
        ...
        'grpHdr
        '
        Me.grpHdr.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txt対象年月, Me.txt担当者別未引当一覧表, Me.lbl仕入, Me.lbl粗利, Me.lbl担当者名, Me.lbl担当者CD, Me.lbl通数, Me.lbl諸経費, Me.lbl売上, Me.lbl固定経費, Me.lbl利益, Me.lbl利益率, Me.txt受注区分})
        Me.grpHdr.GroupKeepTogether = DataDynamics.ActiveReports.GroupKeepTogether.All
        Me.grpHdr.Height = 0.6952756!
    ...
    "rtical-align: bottom; ddo-char-set: 1"
        Me.txt担当者別未引当一覧表.Text = "担当者別原価集計表"
    ...
    "ign: middle; ddo-char-set: 1"
        ...
        Me.lbl担当者名.CharacterSpacing = 10.0!
        Me.lbl担当者名.Height = 0.2559055!
        Me.lbl担当者名.HyperLink = Nothing
        Me.lbl担当者名.Left = 0.6299217!
        Me.lbl担当者名.Name = "lbl担当者名"
        Me.lbl担当者名.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 9pt; text-align: left; vertical-alig" & _
    "n: middle; ddo-char-set: 1"
        Me.lbl担当者名.Text = " 担当者名"
        Me.lbl担当者名.Top = 0.4393701!
        Me.lbl担当者名.Width = 2.145669!
        '
        'lbl担当者CD
        '
        Me.lbl担当者CD.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl担当者CD.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl担当者CD.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl担当者CD.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lbl担当者CD.Height = 0.2559055!
        Me.lbl担当者CD.HyperLink = Nothing
        Me.lbl担当者CD.Left = 0.0000004768372!
        Me.lbl担当者CD.Name = "lbl担当者CD"
        Me.lbl担当者CD.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 7.5pt; text-align: center; vertical-" & _
    "align: middle; ddo-char-set: 1"
        Me.lbl担当者CD.Text = "コード"
        Me.lbl担当者CD.Top = 0.4393701!
        Me.lbl担当者CD.Width = 0.6299213!
        '
        'lbl通数
        '
    ...
    "ddo-char-set: 1"
        ...
        CType(Me.lbl担当者CD, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Private WithEvents lbl担当者CD As DataDynamics.ActiveReports.Label
