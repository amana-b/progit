...
Public Class CustomerDeletePickupList
    ...
    '''========================================================================================
    Private Sub CustomerDeletePickupList_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        ' 総合計
        Me.txt合計.SummaryType = SummaryType.SubTotal
        Me.txt合計.SummaryFunc = SummaryFunc.Sum
        Me.txt合計.SummaryRunning = SummaryRunning.None
        Me.txt合計.SummaryGroup = Me.Detail.Name
        'Me.txt合計.DataField = tbl.合計数Column.ColumnName
