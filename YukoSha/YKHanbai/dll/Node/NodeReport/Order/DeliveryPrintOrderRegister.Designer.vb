...
Partial Public Class DeliveryPrintOrderRegister
    ...
    Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(DeliveryPrintOrderRegister))
        ...
        Me.txt納期別印刷場所別受注台帳 = New DataDynamics.ActiveReports.TextBox()
        ...
        Me.lb受注数 = New DataDynamics.ActiveReports.Label()
        ...
        Me.txt商品納期総計 = New DataDynamics.ActiveReports.TextBox()
        ...
        Me.txt商品納期計 = New DataDynamics.ActiveReports.TextBox()
        ...
        CType(Me.txt納期別印刷場所別受注台帳, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.lb受注数, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.txt商品納期総計, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.txt商品納期計, System.ComponentModel.ISupportInitialize).BeginInit()
    ...
    "o-char-set: 1"
        ...
        Me.txt客先納期.Top = 0.0000009536743!
    ...
    "ddo-char-set: 1"
        ...
        Me.txt印刷場所名.Top = 0.0000009536743!
    ...
    "ddo-char-set: 1"
        ...
        Me.PageHeader.Height = 0.2952756!
    ...
    "ddo-char-set: 1"
        ...
        'grpHdr得意先CD
        '
        Me.grpHdr得意先CD.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txt納期, Me.txt納期別印刷場所別受注台帳, Me.txt新再区分, Me.txtセット区分, Me.lbl先客納期, Me.lbl印刷場所名, Me.lbl作業No, Me.lbl得意先名, Me.ｌｂｌ商品名, Me.lb受注数, Me.lbl受注通数, Me.lbl受注日, Me.lbl備考, Me.lbl納期})
        Me.grpHdr得意先CD.GroupKeepTogether = DataDynamics.ActiveReports.GroupKeepTogether.All
        Me.grpHdr得意先CD.Height = 0.8511817!
        ...
        Me.txt納期.Left = 0.4503937!
        Me.txt納期.Name = "txt納期"
        Me.txt納期.Style = "font-family: ＭＳ 明朝; font-size: 10pt; text-align: left; vertical-align: bottom; dd" & _
    "o-char-set: 1"
        Me.txt納期.Text = "00/00/00～99/99/99　日迄"
        Me.txt納期.Top = 0.0!
        Me.txt納期.Width = 1.879529!
        '
        'txt納期別印刷場所別受注台帳
        '
        Me.txt納期別印刷場所別受注台帳.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.[Double]
        Me.txt納期別印刷場所別受注台帳.Height = 0.2362205!
        Me.txt納期別印刷場所別受注台帳.Left = 3.359449!
        Me.txt納期別印刷場所別受注台帳.Name = "txt納期別印刷場所別受注台帳"
        Me.txt納期別印刷場所別受注台帳.Style = "font-family: ＭＳ 明朝; font-size: 14pt; text-align: center; vertical-align: bottom; " & _
    "ddo-char-set: 1"
        Me.txt納期別印刷場所別受注台帳.Text = "納期別印刷場所別受注台帳"
        Me.txt納期別印刷場所別受注台帳.Top = 0.08110237!
        Me.txt納期別印刷場所別受注台帳.Width = 2.681497!
        '
        'txt新再区分
        '
    ...
    "lign: middle; ddo-char-set: 1"
        ...
        'lb受注数
        '
        Me.lb受注数.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lb受注数.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lb受注数.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lb受注数.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.lb受注数.Height = 0.3346457!
        Me.lb受注数.HyperLink = Nothing
        Me.lb受注数.Left = 7.204722!
        Me.lb受注数.Name = "lb受注数"
        Me.lb受注数.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.lb受注数.Text = "受　注　数"
        Me.lb受注数.Top = 0.5165353!
        Me.lb受注数.Width = 0.9842521!
        '
        'lbl受注通数
        '
    ...
    "lign: middle; ddo-char-set: 1"
        Me.lbl納期.Text = "納期"
        Me.lbl納期.Top = 0.0!
        Me.lbl納期.Width = 0.4503937!
        '
        'grpFtr総合計
        '
        Me.grpFtr総合計.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.TextBox1, Me.TextBox2, Me.txt受注通数合計, Me.txt受注合計数, Me.txt商品納期総計, Me.TextBox6, Me.TextBox7, Me.TextBox8, Me.TextBox9, Me.Label1, Me.Label4})
    ...
    "do-char-set: 1"
        ...
        'txt商品納期総計
        '
        Me.txt商品納期総計.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt商品納期総計.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt商品納期総計.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt商品納期総計.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt商品納期総計.Height = 0.2755905!
        Me.txt商品納期総計.Left = 4.76378!
        Me.txt商品納期総計.Name = "txt商品納期総計"
        Me.txt商品納期総計.Style = "font-family: ＭＳ 明朝; font-size: 11pt; text-align: left; vertical-align: bottom; dd" & _
    "o-char-set: 1"
        Me.txt商品納期総計.Top = 0.0!
        Me.txt商品納期総計.Width = 2.440945!
        '
        'TextBox6
        '
    ...
    "o-char-set: 1"
        ...
        Me.TextBox9.Top = 0.0000009536743!
    ...
    "lign: middle; ddo-char-set: 1"
        ...
        'grpFtr納期計
        '
        Me.grpFtr納期計.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.TextBox5, Me.TextBox19, Me.txt受注通数計, Me.txt受注計数, Me.Label5, Me.txt商品納期計, Me.Label7, Me.TextBox23, Me.TextBox24, Me.TextBox25, Me.TextBox26})
    ...
    "do-char-set: 1"
        ...
        Me.Label5.Left = 6.862993!
        Me.Label5.Name = "Label5"
        Me.Label5.Style = "color: Black; font-family: ＭＳ 明朝; font-size: 11pt; text-align: center; vertical-a" & _
    "lign: middle; ddo-char-set: 1"
        Me.Label5.Text = "件"
        Me.Label5.Top = 0.04094489!
        Me.Label5.Width = 0.2980315!
        '
        'txt商品納期計
        '
        Me.txt商品納期計.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt商品納期計.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt商品納期計.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt商品納期計.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.Solid
        Me.txt商品納期計.Height = 0.2755905!
        Me.txt商品納期計.Left = 4.76378!
        Me.txt商品納期計.Name = "txt商品納期計"
        Me.txt商品納期計.Style = "font-family: ＭＳ 明朝; font-size: 11pt; text-align: left; vertical-align: bottom; dd" & _
    "o-char-set: 1"
        Me.txt商品納期計.Text = Nothing
        Me.txt商品納期計.Top = 0.0!
        Me.txt商品納期計.Width = 2.440945!
        '
        'Label7
        '
        Me.Label7.Height = 0.1968504!
        Me.Label7.HyperLink = Nothing
        Me.Label7.Left = 5.604331!
    ...
    "ddo-char-set: 1"
        ...
        Me.TextBox25.Top = 0.0000009536743!
    ...
    "o-char-set: 1"
        ...
        Me.TextBox26.Top = 0.0000009536743!
        Me.TextBox26.Width = 0.7874014!
        '
        'DeliveryPrintOrderRegister
        '
        ...
        CType(Me.txt納期別印刷場所別受注台帳, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.lb受注数, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.txt商品納期総計, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.txt商品納期計, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Private WithEvents txt商品納期総計 As DataDynamics.ActiveReports.TextBox
    ...
    Private WithEvents txt商品納期計 As DataDynamics.ActiveReports.TextBox
    ...
    Private WithEvents txt納期別印刷場所別受注台帳 As DataDynamics.ActiveReports.TextBox
    ...
    Private WithEvents lb受注数 As DataDynamics.ActiveReports.Label
