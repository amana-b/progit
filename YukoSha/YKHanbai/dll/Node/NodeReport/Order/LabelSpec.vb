...
Public Class LabelSpec
    ...
    '''========================================================================================
    Private Sub LabelSpec_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        '------------------------------------------------------------------------------------------
        ' Header
        Me.txt紙管サイズ.OutputFormat = "#,###"
        Me.txt色数.OutputFormat = "#,###"
        Me.txt巻き数.OutputFormat = "#,###"
        Me.txt面付け数.OutputFormat = "#,###"
        Me.txt製造ロット.OutputFormat = "#,###"
        Me.txt初回単価.OutputFormat = "###.00"
        Me.txtリピート単価.OutputFormat = "###.00"
        ' Detail
