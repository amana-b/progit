...
Public Class OrderPlanReport
    ...
    '''========================================================================================
    Private Sub OrderPlanReport_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        ' Header
        ' Detail
        Me.txt受注予測枚数.OutputFormat = "#,###"
        Me.txt受注予測通数.OutputFormat = "#,###"
        Me.txt前回受注枚数.OutputFormat = "#,###"
        Me.txt2回前受注枚数.OutputFormat = "#,###"
        Me.txt3回前受注枚数.OutputFormat = "#,###"
