...
Public Class OrderSlipSubAhead
    ...
    '''========================================================================================
    Private Sub OrderSlipSubAhead_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        ' ｸﾞﾙｰﾌﾟ ﾌｯﾀ
        '------------------------------------------------------------------------------------------
        Me.grpFtr得意先CD.NewPage = NewPage.After
        ...
        '------------------------------------------------------------------------------------------
        ' Header
        Me.txtHdr発注数.OutputFormat = "#,###"
        Me.txtHdr通数.OutputFormat = "#,###"
        Me.txtHdr発注金額.OutputFormat = "#,###"
        Me.txtHdr発注単価.OutputFormat = "###.00"
        Me.txtHdr受注数.OutputFormat = "#,###"
        Me.txtHdr受注金額.OutputFormat = "#,###"
        Me.txtHdr受注単価.OutputFormat = "###.00"
        ' Detail
        ...
        ' ｻﾌﾞﾚﾎﾟｰﾄ
        '------------------------------------------------------------------------------------------
        Me.OrderSlipAheadSubPaper.Report = New NodeReport.CustomerListSub
        Me.OrderSlipAheadSubPaper.ReportName = "CustomerListSub"
        Me.OrderSlipAheadSubPaper.CanGrow = False
    End Sub
    ...
    Private Sub grpFtr得意先CD_Format(sender As System.Object, e As System.EventArgs) Handles grpFtr得意先CD.Format
