...
Public Class OrderSlipSub
    ...
    '''========================================================================================
    Private Sub OrderSlipSub_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        ' Detail
        Me.txt発注数.OutputFormat = "#,###"
        Me.txt発注単価.OutputFormat = "###.00"

        '------------------------------------------------------------------------------------------
        ' ｻﾌﾞﾚﾎﾟｰﾄ
        '------------------------------------------------------------------------------------------
        Me.OrderSlipSubPaper.Report = New NodeReport.CustomerListSub
        Me.OrderSlipSubPaper.ReportName = "CustomerListSub"
        Me.OrderSlipSubPaper.CanGrow = False
    End Sub
