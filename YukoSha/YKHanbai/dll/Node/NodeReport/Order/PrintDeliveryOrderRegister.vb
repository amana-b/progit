...
Public Class PrintDeliveryOrderRegister
    ...
    '''========================================================================================
    Private Sub PrintDeliveryOrderRegister_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        ' 総合計
        Me.txt印刷場所計.SummaryType = SummaryType.SubTotal
        Me.txt印刷場所計.SummaryFunc = SummaryFunc.Sum
        Me.txt印刷場所計.SummaryRunning = SummaryRunning.None
        Me.txt印刷場所計.SummaryGroup = Me.Detail.Name
        'Me.txt印刷場所計.DataField = tbl.合計数Column.ColumnName
