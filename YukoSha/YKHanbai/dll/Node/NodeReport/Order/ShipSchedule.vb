...
Public Class ShipSchedule
    ...
    '''========================================================================================
    Private Sub ShipSchedule_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        ' 総合計
        Me.txt発送日計.SummaryType = SummaryType.SubTotal
        Me.txt発送日計.SummaryFunc = SummaryFunc.Sum
        Me.txt発送日計.SummaryRunning = SummaryRunning.None
        Me.txt発送日計.SummaryGroup = Me.Detail.Name
        'Me.txt発送日計.DataField = tbl.合計数Column.ColumnName
