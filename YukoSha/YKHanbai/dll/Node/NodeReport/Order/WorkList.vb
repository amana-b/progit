...
Public Class WorkList
    ...
    '''========================================================================================
    Private Sub WorkList_ReportStart(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        '------------------------------------------------------------------------------------------
        ' 変数定義
        '------------------------------------------------------------------------------------------
        ...
        Me.txt得意先件数.SummaryType = SummaryType.SubTotal
        Me.txt得意先件数.SummaryFunc = SummaryFunc.Sum
        Me.txt得意先件数.SummaryRunning = SummaryRunning.None
        Me.txt得意先件数.SummaryGroup = Me.Detail.Name
        'Me.txt得意先件数.DataField = tbl.合計数Column.ColumnName
    ...
    Private Sub grpHdr得意先CD_Format(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub GroupHeader1_Format(sender As System.Object, e As System.EventArgs) Handles grpHdr.Format

    End Sub

    Private Sub grpFtr件数合計_Format(sender As System.Object, e As System.EventArgs) Handles grpFtr.Format
